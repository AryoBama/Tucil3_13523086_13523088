...
public class SolveController {
    ...
    @PostMapping("/IDA")
    public ResponseEntity<Map<String, Object>>SolveWithIDA(@RequestBody BoardRequest request) {
        Map<String, Object> response = new HashMap<>();
        List<Map<String, Object>> steps = new ArrayList<>();
        ...
        CountHeuristic heuristic = new BlockingCar(board);
        
        List<BoardState> result = new LinkedList<>();
        long startTime = System.nanoTime();
        IDA ida = new IDA();
        Integer cntNode = ida.solveIDA(board, heuristic, result);
        long endTime = System.nanoTime();
        long duration = endTime - startTime;
        duration /= 1_000_000.0;
        System.out.println("Durasinya: " + duration);
    ...
    @PostMapping("/AStar")
    public ResponseEntity<Map<String, Object>>SolveWithAStar(@RequestBody BoardRequest request) {
        Map<String, Object> response = new HashMap<>();
        List<Map<String, Object>> steps = new ArrayList<>();
        ...
        List<BoardState> result = new LinkedList<>();
        long startTime = System.nanoTime();
        Integer cntNode = AStar.solveAStar(board, heuristic,result);
        long endTime = System.nanoTime();
        long duration = endTime - startTime;
        duration /= 1_000_000.0;
        System.out.println("Durasinya: " + duration);
